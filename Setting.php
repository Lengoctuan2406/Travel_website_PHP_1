...
<html lang="en">
    ...
    if (isset($_POST['Update'])) {
        ...
        $tieusu = $_POST['tieusu'];
        $diachi = $_POST['diachi'];
        $sql = "update users set user='$tk', pass='$mk', name='$hoten', email='$mail', gioitinh='$gioitinh', ngaysinh='$ngaysinh', sodt=$sodt, diachi='$diachi', tieusu='$tieusu' where id=$id";
        $connect->query($sql);
    }
                                            ...
                                            <div class="d-flex flex-row mt-2">
                                                <div class="tab-pane fade show active" id="edit-profile" >
                                                    ...
                                                    <div class="stg-form-area">
                                                        <form method="post" class="c-form" action="Setting.php">
                                                            <div class="uzer-nam">
                                                            ...
                                                            <div class="uzer-nam">
                                                                <label>Họ tên</label>
                                                                <input type="text" value="<?php echo $row[5] ?>" name="hoten">
                                                            </div>
                                                            <div>
                                                                <label>Địa chỉ mail</label>
                                                                <input type="text" value="<?php echo $row[6] ?>" name="mail">
                                                            </div>
                                                            <div>
                                                                <label>Số điện thoại</label>
                                                                <input type="text" value="<?php echo $row[9] ?>" name="sodt">
                                                            </div>
                                                            <div>
                                                                <label>Mật khẩu</label>
                                                                <input type="text" value="<?php echo $row[4] ?>" name="mk">
                                                            </div>
                                                            <div>
                                                                ...
                                                                <div class="form-radio">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" checked="checked" name="gioitinh" value="Nam"><i class="check-box"></i>Nam
                                                                        </label>
                                                                    </div>
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="gioitinh" value="Nữ"><i class="check-box"></i>Nữ
                                                                        </label>
                                                                    </div>
                                                            ...
                                                            <div>
                                                                <label>Tiểu sử</label>
                                                                <input type="text" style="height: 50px" value="<?php echo $row[11] ?>" name="tieusu">
                                                            </div>	
                                                            <div>
                                                                <label>Địa chỉ</label>
                                                                <input type="text" value="<?php echo $row[6] ?>" name="diachi">
                                                            </div>
                                                            <button type="submit" data-ripple="" name="thoat" formaction="1Xulydangxuat.php">Thoát</button>
                                                            <button type="submit" name="Update" value="<?php echo $row[0] ?>">Lưu</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-3">
                                    <aside class="sidebar static">
                                        <div class="widget">
                                            ...
                                            <div class="your-page">
                                                <figure><a title="" href="#"><img alt="" src="profile/images/male.png"></a></figure>
                                                <div class="page-meta">
                                                    <a class="underline" title="" href="#">Trang của tôi</a>
                                                    <span><i class="ti-comment"></i>Tin <em class="bg-blue">9</em></span>
                                                    <span><i class="ti-bell"></i>Thông báo <em class="bg-purple">2</em></span>
                                                </div>
                                                <div class="page-likes">
                                                    <ul class="nav nav-tabs likes-btn">
                                                        <li class="nav-item"><a data-toggle="tab" href="#link1" class="active">thích</a></li>
                                                        <li class="nav-item"><a data-toggle="tab" href="#link2" class="">xem</a></li>
                                                    </ul>
