        ...
        <section id="above-the-fold">
            <div class="container_wrapper">
                <section id="navigation_container">
                    <div id="branding"><a href="index.html" style='text-decoration: none;'>
                ...
                <h1 id="above-the-fold__description">
                    ...
                    <?php
                    include "1connect.php";
                    $str = "select tongtien from hoadon, users where hoadon.id=users.id and dangnhap=1 order by mahoadon desc";
                    $result = $connect->query($str);
